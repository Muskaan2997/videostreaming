...
$msg='';
$qry="select * from contact where id='1'";
...
$person = mysqli_real_escape_string($con,$person);
 $query = mysqli_query($con,"update contact set person='$person',address='$address', email='$email', contact='$contact' where id='1'");
if($query)
...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>Contact Details - RN Electricals</title>
		<!-- start: META -->
								...
								<form action="" method="post" enctype="multipart/form-data" role="form" id="contact-form">
										...
										<div class="row">
											...
											<div class="form-group">
													...
													<textarea name="address" placeholder="Address" class="form-control" id="address" ><?php echo $rs['address']; ?></textarea>
											</div>
											<div class="form-group">
													<label class="control-label">
														Contact Person<span class="symbol required"></span>
													</label>
													<input name="person" placeholder="Contact Person" value="<?php echo $rs['person']; ?>" class="form-control" id="person" >
											</div>
											<div class="form-group">
													<label class="control-label">
														Contact <span class="symbol required"></span>
													</label>
													<input name="contact" placeholder="Contact" value="<?php echo $rs['contact']; ?>" class="form-control" id="contact" >
											</div>
											<div class="form-group">
													<label class="control-label">
														Email <span class="symbol required"></span>
													</label>
													<input name="email" placeholder="Email" value="<?php echo $rs['email']; ?>" class="form-control" id="email" >
											</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<button name="save_contact" class="btn btn-primary btn-wide " type="submit" value="Save">
