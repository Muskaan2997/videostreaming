				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
								  ...
								  <span class="mainDescription">Change your account password</span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Dashboard</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
								<form action="update_password.php" method="post" enctype="multipart/form-data" role="form" id="settings-form">
										<div class="row">
											<div class="col-md-12">
